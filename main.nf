...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    nf-core/sitedetect
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Github : https://github.com/nf-core/sitedetect
    Website: https://nf-co.re/sitedetect
    Slack  : https://nfcore.slack.com/channels/sitedetect
----------------------------------------------------------------------------------------
*/
...
workflow NFCORE_SITEDETECT {
    ...
    emit:
    multiqc_report = SITEDETECT.out.multiqc_report // channel: /path/to/multiqc_report.html
}
/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    RUN MAIN WORKFLOW
...
workflow {
    ...
    PIPELINE_COMPLETION (
        ...
        params.outdir,
        params.monochrome_logs,
        NFCORE_SITEDETECT.out.multiqc_report
    )
}
